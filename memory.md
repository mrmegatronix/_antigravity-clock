# Agent Memory Bank: _antigravity-clock

> Persistent knowledge, architecture, patterns, and decisions synced via `agent-memory-mcp`.

## 1. Project Overview & Architecture
- **Repository**: `_antigravity-clock`
- **Type**: Clock / Time Display Signage
- **Tech Stack**: CSS3, HTML5, Vanilla JavaScript
- **Entry Points**: index.html
- **Description**: Clock / Time Display Signage for _antigravity-clock.
